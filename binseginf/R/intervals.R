...
##' @export
intervals <- function(numIntervals, n, comprehensive=FALSE, existing=NULL, distance=0, maxlength=n-1, precuts=NULL) {
    ...
    if(comprehensive){
        ...
        while(!enough.intervals){
            ...
            eliminate = c(too.close, too.long, crosses) ## crosses was added
