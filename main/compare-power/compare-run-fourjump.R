...
## "binseginf/binseginf".  This is for the four-jump case! Not included in main
## paper.
...
## ## Temporary tst code
## print("Running last grain of inferences (only within vicinity 2 of true jumps) for type:")
## ii.list = length(levs)
